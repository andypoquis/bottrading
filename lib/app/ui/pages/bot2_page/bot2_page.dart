...
class Bot2Page extends GetView<Bot2Controller> {
  @override
          ...
          Container(
            ...
            child: Obx(() => Column(
                  ...
                  children: [
                    ...
                    Text(
                        'ADA: ${(controller.devices.isEmpty) ? 'Hola' : controller.devices[0].cantCripto} ',
                        style: const TextStyle(
                            color: titleColor,
                            fontSize: 10,
                            fontWeight: FontWeight.w600)),
                    spaceH(10),
                    Obx(() => Text('${controller.lastClosePrice.value}',
                        style: const TextStyle(
                            color: titleColor,
                            fontSize: 24,
                ...
                children: [
                  cardDescripton(
                      (controller.devices.isEmpty)
                          ? 'Hola'
                          : controller.devices[0].capital!.toStringAsFixed(4),
                      'Ganancia'),
                  Expanded(
                    child: Container(),
                  ),
                  cardDescripton(
                      (controller.devices.isEmpty)
                          ? 'Hola'
                          : controller.devices[0].valueCripto!
                              .toStringAsFixed(4),
                      'Rentabilidad'),
                  Expanded(
                    child: Container(),
                  ...
                  cardDescripton(
                      (controller.devices.isEmpty)
                          ? 'Hola'
                          : controller.devices[0].cantCripto!
                              .toStringAsFixed(4),
                      'Rentabilidad')
                ],
              )),
